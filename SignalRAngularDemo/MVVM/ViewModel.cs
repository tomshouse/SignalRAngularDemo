...
namespace SignalRAngularDemo.MVVM
{
    public class ViewModel : IDisposable
    {
        ...
        public ViewModel(object instance, string? id)
        {
        ...
        public ViewModel GetPropertyAsViewModelPartial(string propertyName, string childId)
        {
            var propInfo = _instanceType.GetProperty(propertyName);
            return new ViewModel(propInfo.GetValue(_instance),childId);
        }
